...
const GradesByTeacher = () => {
    ...
    const students = [
        { name: "Maria", lastName: "Lopez", codigo: "011", nota: "-1", email: "marialopez@edupro.com" },{ name: "Mario", lastName: "I'am", codigo: "012", nota: "-51", email: "IamMario@edupro.com" },{ name: "Marioneta", lastName: "Ledesma", codigo: "014", nota: "10", email: "MarioLede@edupro.com" },{ name: "Juan", lastName: "Perez", codigo: "015", nota: "8", email: "juanperez@edupro.com" },{ name: "Ana", lastName: "Gomez", codigo: "016", nota: "7", email: "anagomez@edupro.com" },{ name: "Lucas", lastName: "Ramirez", codigo: "017", nota: "9", email: "lucasramirez@edupro.com" },{ name: "Sofia", lastName: "Martinez", codigo: "018", nota: "6", email: "sofiamartinez@edupro.com" },{ name: "Pedro", lastName: "Gonzalez", codigo: "019", nota: "5", email: "pedrogonzalez@edupro.com" },{ name: "Laura", lastName: "Lopez", codigo: "020", nota: "4", email: "lauralopez@edupro.com" }
    ];
    ...
    return (
        ...
        <div className="overflow-x-auto">
            ...
            <tbody className="bg-white text-black">
                ...
                <tr key={index}>
                    <td className="py-2 px-4 text-center font-bold border border-[#9C9898] border-r-0">{student.codigo}</td>
                    <td className="py-2 px-4 text-center border border-[#9C9898] border-r-0 border-l-0">{`${student.name} ${student.lastName}`}</td>
                    <td className="py-2 px-4 text-center border border-[#9C9898] border-r-0 border-l-0">{student.email}</td>
                    <td className="py-2 px-4 text-center font-bold border border-[#9C9898] border-r-0 border-l-0">{student.nota}</td>
        ...
        <div className='p-1'>
            ...
            <p className='text-sm pl-1'>Fecha de entrega: 05/09/2024
            </p>
        </div>
