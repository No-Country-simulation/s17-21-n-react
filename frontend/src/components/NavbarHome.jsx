        ...
        <nav className="shadow-md">
            <div className="container mx-auto px-4 py-2 flex justify-between items-center">
                <div className="text-2xl font-bold text_primary">
                    <Link to="/">Educa<span className="text-primary">Pro</span></Link>
                </div>
                ...
                <div className="hidden md:flex items-center">
                    <Link to="#login">
                    <button className="bg-primary text-white px-4 py-2 rounded hover:bg-secondary transition duration-200 flex items-center">
                        <span>Acceso</span>
            ...
            {isOpen && (
                <div className="md:hidden bg-white shadow-md mt-2 py-2">
                    {navItems.map((item) => (
                        <Link key={item.id} to={item.to} className="block px-4 py-2 text-gray-600 hover:bg-blue-500 hover:text-white transition duration-200">
                            {item.label}
                        </Link>
                    ))}
                </div>
