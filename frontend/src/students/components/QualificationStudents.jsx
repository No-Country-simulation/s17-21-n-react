...
const QualificationStudents = () => {
    ...
    return (
        <>
            ...
            <div className='bg-customGradient mt-10 justify-start flex-row w-auto h-auto ml-96 mr-10 text-white p-8 md:flex-col md:items-center md:mx-2 md:w-auto md:p-2 sm:flex-col sm:items-center sm:mx-2 sm:w-auto sm:p-2'>
                <svg
                ...
                <h1 className='pl-4 text-6xl md:items-center md:text-center md:mx-auto md:w-auto md:p-2 sm:items-center sm:text-center sm:mx-auto sm:w-auto sm:p-2'>Calificaciones</h1>
            </div>
                ...
                <div className="w-full grid grid-cols-3 border border-black ">
                    ...
                    <div className='w-full gap-2 items-center'>
                        <p className='bg-badge_green text-white justify-between flex flex-row border font-bold text-xl border-black p-4'>
                            <svg
                                ...
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M11 16.914L6.293 12.207L7.707 10.793L11 14.086L20.675 4.411C20.318 3.864 19.702 3.5 19 3.5H5C3.895 3.5 3 4.395 3 5.5V19.5C3 20.605 3.895 21.5 5 21.5H19C20.105 21.5 21 20.605 21 19.5V6.914L11 16.914Z"
                                    fill="#F5F5F5" />
                            </svg>
                            <p className='w-1/2'>
                                <span className='text-center'>10</span></p>
                        </p>
                        <p className='bg-badge_green text-white justify-between flex flex-row border font-bold text-xl border-black p-4'>
                            <svg
                                className='text-left pl-0.5'
                            ...
                            <p className='w-1/2'>
                                <span className='text-center'>8</span></p>
                        </p>
                        <p className='bg-warning text-white justify-between flex flex-row border font-bold text-xl border-black p-4'>
                            ...
                            <p className='w-1/2'>
                                <span className='text-center'>4</span></p>
                        </p>
                        <p className='bg-badge_green text-white justify-between flex flex-row border font-bold text-xl border-black p-4'>
                            <svg
                                className='text-left pl-0.5'
                            ...
                            <p className='w-1/2'>
                                <span className='text-center'>9</span></p>
                        </p>
                        <p className='bg-lightGray text-white text-left flex flex-row border font-bold text-xl border-black p-4'>
                            ...
                            <p className='pl-4'>
                                <span className='text-center'>Próxima</span></p>
                        </p>
                        <p className='bg-lightGray text-white text-left flex flex-row border font-bold text-xl border-black p-4'>
                            <svg
                                className='pl-0.5'
                    ...
                    <div className='w-full items-center gap-3'>
                        <p className='bg-badge_blue bg-opacity-70 text-white text-left flex flex-row border font-bold text-xl border-black p-4 sm:text-lg'>
                            ...
                            <p className='pl-4'>
                                <span className='text-center'>Ver correcciones</span></p>
                        </p>
                        <p className='bg-badge_blue bg-opacity-70 text-white text-left flex flex-row border font-bold text-xl border-black p-4 sm:text-lg'>
                            <svg width="20"
                                height="20"
